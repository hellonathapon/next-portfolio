...
function header() {
  return (
    <header className="fixed top-0 w-full flex">
      <div className="max-w-screen-md backdrop-blur-md bg-white/30 w-full py-3 mx-auto flex flex-row justify-center px-5 md:px-0">
        ...
        <ul className="hidden h-full ml-3 gap-3 self-end md:flex md:flex-row md:justify-center md:items-center">
          <li className="hover:underline hover:cursor-pointer">Work</li>
